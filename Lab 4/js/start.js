...
LEAGUE.Start = {
    ...
    validate : function(error){
        ...
        if(LEAGUE.Start.valid === true){
            LEAGUE.Start.processTeam(LEAGUE.Start.teamName, LEAGUE.Start.street, LEAGUE.Start.zipcode, LEAGUE.Start.city, LEAGUE.Start.phone, LEAGUE.Start.teamEmail, teamId);
        }
    ...
    processTeam : function(teamName, street, zipcode, city, phone, teamEmail, teamId){
