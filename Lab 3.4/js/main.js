...
var Main = {
        ...
        // Antal gymnaster
            ...
            if(valid === true){
                for(var i = 0; i < Main.gymnasts.length; i += 1){
                    ...
                    Main.calculateTeamPnts(Gymnast.prototype.points(points));
                    points = [];
                }
            }
    ...
    calculateTeamPnts : function(points) {
        // points är lika med gymnastens medelpoäng för grenen
        console.log("GYMNAST " + points);
        Main.teamPnts.push(points);
        console.log(Main.teamPnts);
        
        if(Main.teamPnts.length === Main.gymnasts.length){
            console.log("TEAMPNTS");
            //Team.prototype.teamPnts(Main.teamPnts);
            //Team.prototype.teamTotalPnts(Team.prototype.teamPnts(Main.teamPnts));
            Main.calulateTeamTotalPnts(Team.prototype.teamPnts(Main.teamPnts));
        }
    },
    
    calulateTeamTotalPnts : function(points) {
        Main.calulateTeamLeaguePnts(Team.prototype.teamTotalPnts(points));
        // console.log("Team competition score: " + Main.teamTotalPnts);
    },
    
    calulateTeamLeaguePnts : function(points) {
        Team.prototype.teamLeaguePnts(points);
    }
